...
os.environ['KAGGLE_CONFIG_DIR'] = r'C:\Users\ongju\.kaggle'  # Update this path to your Kaggle configuration directory

# Specify the dataset identifier
dataset = 'piterfm/paris-2024-olympic-summer-games'

# Set the download path
download_path = r'C:\Users\ongju\Dropbox\PC\Downloads\Olympic Dashboard\Source' # Change this to your preferred download directory
